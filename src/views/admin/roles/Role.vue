<template>
    ...
    <Dialog v-model:visible="visibleRol" :style="{ width: '600px' }" header="ROL">
        <div class="flex flex-col gap-6">
            <div>
                <label for="name" class="block font-bold mb-3">Nombre Rol</label>
                <InputText v-model="role.name" id="name" required autofocus fluid />
                <!-- <small v-if="submitted && !role.name" class="text-red-500"></small> -->
            </div>
            <div>
